...
import { applyjobs, getApplication, getAppliedJob, updateApplicationStatus } from "../Controller/ApplicationController.js";


const applicationRouter = express.Router();

applicationRouter.route("/apply/:id").get(jwtAuth,applyjobs);
applicationRouter.route("/get-appliedJob").get(jwtAuth,getAppliedJob);
